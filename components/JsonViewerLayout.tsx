      ...
      <main className="container mx-auto px-4 py-6 space-y-6">
        <div className="grid grid-cols-5 gap-4">
          <Card className="col-span-1">
            ...
            <CardContent className="space-y-2">
              {jsonHistory.map(item => {
                const preview = item.json.length > 32 ? item.json.slice(0, 32) + '...' : item.json;
                return (
                  <div key={item.id} className="rounded-lg bg-muted p-2 flex flex-col items-start shadow-sm">
                    <button
          ...
          <Card className="col-span-2">
            ...
            <CardContent>
              <textarea
                ...
                className="w-full h-[300px] p-2 font-mono text-sm bg-background border rounded-md resize-none"
          ...
          <Card className="col-span-2">
            ...
            <CardContent>
              <div className="w-full h-[300px] p-2 font-mono text-sm rounded-md overflow-auto" style={{background: theme === 'dark' ? '#282c34' : '#f5f5f5'}}>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <pre className="p-2 bg-muted rounded-md font-mono text-sm overflow-auto max-h-[300px]">
                  {selectedNode ? JSON.stringify(selectedNode, null, 2) : 'No node selected'}
                </pre>
              </div>
            </CardContent>
          </Card>
